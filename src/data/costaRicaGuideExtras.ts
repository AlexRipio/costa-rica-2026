...
export type PlaceRecommendation = {
  name: string
  label: 'Nuestra elección' | 'Lo probamos' | 'Calidad-precio' | 'Soda local' | 'Opción especial'
  category: 'Hotel' | 'B&B' | 'Bungaló' | 'Hostel' | 'Lodge' | 'Soda' | 'Restaurante' | 'Café y desayuno' | 'Cena especial'
  priceRange: string
  priceBasis: 'habitación doble / noche' | 'según tipo / noche' | 'por persona'
  featured?: boolean
  premium?: boolean
  text: string
  mapUrl: string
...
export const costaRicaGuideExtras: Record<string, CostaRicaGuideExtra> = {
  'alajuela-bajos-del-toro': {
    ...
    stayRecommendations: [
      { name: 'El Rodeo Estancia Boutique Hotel', label: 'Nuestra elección', category: 'Hotel', priceRange: '90–140 USD', priceBasis: 'habitación doble / noche', featured: true, text: 'Nuestra primera noche cerca del aeropuerto, con aparcamiento y una ubicación práctica para recoger el coche al día siguiente.', mapUrl: maps('El Rodeo Estancia Boutique Hotel Alajuela Costa Rica') },
      { name: 'La Guaria Inn & Suites', label: 'Calidad-precio', category: 'Hotel', priceRange: '55–90 USD', priceBasis: 'habitación doble / noche', text: 'Alternativa sencilla en Alajuela para una noche de llegada o salida, recurrente en guías de presupuesto por su cercanía al aeropuerto.', mapUrl: maps('La Guaria Inn & Suites Alajuela Costa Rica') },
      { name: 'Hotel La Paz', label: 'Calidad-precio', category: 'B&B', priceRange: '65–110 USD', priceBasis: 'habitación doble / noche', text: 'En Poasito, encaja si prefieres despertar ya en la montaña y acercarte a Poás o Bajos del Toro sin pagar un lodge de lujo.', mapUrl: maps('Hotel La Paz Poasito Costa Rica') },
      { name: 'Peace Lodge', label: 'Opción especial', category: 'Lodge', priceRange: '650–1.100 USD', priceBasis: 'habitación doble / noche', premium: true, text: 'La gran opción de montaña junto a La Paz Waterfall Gardens: cara, pero la más especial de esta etapa por entorno, habitaciones y acceso temprano a los jardines.', mapUrl: maps('Peace Lodge Vara Blanca Costa Rica') },
    ],
    ...
    eatRecommendations: [
      { name: 'Restaurante Catarata del Toro', label: 'Lo probamos', category: 'Restaurante', priceRange: '6–10 USD', priceBasis: 'por persona', featured: true, text: 'La opción dentro del recinto: cómoda para no desviar la ruta. En nuestra visita la hamburguesa costaba 8 USD, el perrito 6 USD y la comida se pagaba en efectivo.', mapUrl: maps('Restaurante Catarata del Toro Costa Rica') },
      { name: 'Soda El Sesteo', label: 'Soda local', category: 'Soda', priceRange: '6–12 USD', priceBasis: 'por persona', text: 'Una parada clásica en Alajuela para desayunos y platos costarricenses sin el precio de los restaurantes del aeropuerto.', mapUrl: maps('Soda El Sesteo Alajuela Costa Rica') },
      { name: 'Chubascos', label: 'Calidad-precio', category: 'Restaurante', priceRange: '15–30 USD', priceBasis: 'por persona', text: 'Restaurante de montaña en Fraijanes muy utilizado como parada hacia Poás; buena opción si el horario encaja con la ruta.', mapUrl: maps('Chubascos Restaurante Fraijanes Alajuela Costa Rica') },
      { name: 'El Rodeo Steak House', label: 'Opción especial', category: 'Cena especial', priceRange: '30–60 USD', priceBasis: 'por persona', premium: true, text: 'La opción cara más cómoda cerca del aeropuerto: un steakhouse clásico dentro del hotel donde dormimos, para cerrar o empezar la ruta sin otro desplazamiento.', mapUrl: maps('El Rodeo Steak House Alajuela Costa Rica') },
    ],
  ...
  'la-fortuna-arenal': {
    ...
    stayRecommendations: [
      { name: 'Natura Bungalows', label: 'Nuestra elección', category: 'Bungaló', priceRange: '120–220 USD', priceBasis: 'habitación doble / noche', featured: true, text: 'Nuestro alojamiento favorito del viaje: bungaló independiente, tranquilidad y vistas directas al volcán cuando despejaba.', mapUrl: maps('Natura Bungalows La Fortuna Costa Rica') },
      { name: 'Hotel Monte Real', label: 'Calidad-precio', category: 'Hotel', priceRange: '70–145 USD', priceBasis: 'habitación doble / noche', text: 'Opción familiar cerca del centro, recomendada en blogs por combinar habitaciones sencillas, jardín, piscina y ubicación caminable.', mapUrl: maps('Hotel Monte Real La Fortuna Costa Rica') },
      { name: 'Arenal Xilopalo', label: 'Calidad-precio', category: 'Hotel', priceRange: '45–90 USD', priceBasis: 'habitación doble / noche', text: 'Alternativa económica a poca distancia del pueblo, útil si prefieres gastar más en actividades que en un resort.', mapUrl: maps('Arenal Xilopalo La Fortuna Costa Rica') },
      { name: 'Casa Luna Hotel & Spa', label: 'Calidad-precio', category: 'Hotel', priceRange: '130–220 USD', priceBasis: 'habitación doble / noche', text: 'Una opción entre jardines al sur del pueblo recuperada de la lista que nos pasaron; compara el precio final con hoteles del centro antes de decidir.', mapUrl: maps('Casa Luna Hotel & Spa La Fortuna Costa Rica') },
      { name: 'Nayara Springs', label: 'Opción especial', category: 'Lodge', priceRange: '700–1.300 USD', priceBasis: 'habitación doble / noche', premium: true, text: 'La opción cara y más especial del Arenal: villas para adultos, selva, servicio muy cuidado y piscina termal privada. Es un capricho, no una elección de calidad-precio.', mapUrl: maps('Nayara Springs La Fortuna Costa Rica') },
    ],
    ...
    eatRecommendations: [
      { name: 'Soda La Fortuna', label: 'Lo probamos', category: 'Soda', priceRange: '8–12 USD', priceBasis: 'por persona', featured: true, text: 'Nuestra recomendación personal para un casado completo sin pagar el precio de los locales más turísticos. Nosotros pagamos unos 8–10 USD.', mapUrl: maps('Soda La Fortuna La Fortuna Costa Rica') },
      { name: 'Soda La Hormiga', label: 'Soda local', category: 'Soda', priceRange: '7–13 USD', priceBasis: 'por persona', text: 'Muy repetida en guías de viaje para desayunar gallo pinto y comer platos típicos a precio contenido.', mapUrl: maps('Soda La Hormiga La Fortuna Costa Rica') },
      { name: 'Soda Víquez', label: 'Soda local', category: 'Soda', priceRange: '10–15 USD', priceBasis: 'por persona', text: 'Otra alternativa céntrica para casados, zumos y cocina costarricense; las referencias recientes sitúan una cena para dos alrededor de 25 USD.', mapUrl: maps('Soda Viquez La Fortuna Costa Rica') },
      { name: 'El Chante Verde', label: 'Calidad-precio', category: 'Restaurante', priceRange: '15–30 USD', priceBasis: 'por persona', text: 'Restaurante ajardinado fuera del centro guardado para una comida tranquila; revisa carta y horario antes de desplazarte.', mapUrl: maps('El Chante Verde La Fortuna Costa Rica') },
      { name: 'Don Rufino', label: 'Opción especial', category: 'Cena especial', priceRange: '35–70 USD', priceBasis: 'por persona', premium: true, text: 'La cena cara que más merece la pena valorar en La Fortuna: cocina contemporánea con producto costarricense y una reputación muy consolidada. Conviene reservar.', mapUrl: maps('Don Rufino La Fortuna Costa Rica') },
    ],
  ...
  monteverde: {
    ...
    stayRecommendations: [
      { name: 'Monteverde Eco Love', label: 'Nuestra elección', category: 'B&B', priceRange: '50–95 USD', priceBasis: 'habitación doble / noche', featured: true, text: 'El alojamiento de nuestra ruta, bien situado para movernos por Santa Elena y descansar después de las actividades.', mapUrl: maps('Monteverde Eco Love Monteverde Costa Rica') },
      { name: 'Cabinas Eddy B&B', label: 'Calidad-precio', category: 'B&B', priceRange: '50–90 USD', priceBasis: 'habitación doble / noche', text: 'Alojamiento sencillo cerca de Santa Elena, citado en guías por su desayuno y por permitir moverse a pie.', mapUrl: maps('Cabinas Eddy B&B Monteverde Costa Rica') },
      { name: "Freddy's Place B&B", label: 'Calidad-precio', category: 'B&B', priceRange: '50–95 USD', priceBasis: 'habitación doble / noche', text: 'Pequeño bed and breakfast familiar con desayuno, una alternativa práctica frente a los hoteles de montaña más caros.', mapUrl: maps("Freddy's Place B&B Monteverde Costa Rica") },
      { name: 'Camino Verde Bed & Breakfast', label: 'Calidad-precio', category: 'B&B', priceRange: '70–215 USD', priceBasis: 'habitación doble / noche', text: 'Otra alternativa céntrica en Santa Elena, guardada para comparar por desayuno, vistas y facilidad para organizar traslados.', mapUrl: maps('Camino Verde Bed & Breakfast Monteverde Costa Rica') },
      { name: 'Cloud Forest Lodge', label: 'Opción especial', category: 'Lodge', priceRange: '270–600 USD', priceBasis: 'habitación doble / noche', premium: true, text: 'La opción cara más recomendable para vivir el bosque sin renunciar a comodidad: lodge entre naturaleza, rutas propias y un restaurante especialmente bien valorado.', mapUrl: maps('Cloud Forest Lodge Monteverde Costa Rica') },
    ],
    ...
    eatRecommendations: [
      { name: 'Sabor Tico', label: 'Soda local', category: 'Soda', priceRange: '6–13 USD', priceBasis: 'por persona', featured: true, text: 'Nuestra recomendación principal de la zona: cocina costarricense, carta amplia y precios razonables; los platos principales rondan 3.000–6.500 colones.', mapUrl: maps('Sabor Tico Monteverde Costa Rica') },
      { name: 'Soda La Amistad', label: 'Soda local', category: 'Soda', priceRange: '6–12 USD', priceBasis: 'por persona', text: 'Alternativa sencilla para casados y comida local, alejada del concepto de restaurante turístico de moda.', mapUrl: maps('Soda La Amistad Monteverde Costa Rica') },
      { name: 'La Cuchara de la Abuela', label: 'Calidad-precio', category: 'Restaurante', priceRange: '8–16 USD', priceBasis: 'por persona', text: 'Cocina típica dentro del entorno de CASEM; una parada interesante para unir comida local y artesanía.', mapUrl: maps('La Cuchara de la Abuela CASEM Monteverde Costa Rica') },
      { name: 'Santa Elena Coffee Shop', label: 'Calidad-precio', category: 'Café y desayuno', priceRange: '6–14 USD', priceBasis: 'por persona', text: 'Café de Café Monteverde en el pueblo, útil para desayunar o probar producto local sin convertirlo en una excursión separada.', mapUrl: maps('Santa Elena Coffee Shop Cafe Monteverde Costa Rica') },
      { name: 'San Lucas Treetop Dining', label: 'Opción especial', category: 'Cena especial', priceRange: '135–180 USD', priceBasis: 'por persona', premium: true, text: 'La experiencia gastronómica cara y verdaderamente distinta de Monteverde: menú degustación en cabinas elevadas entre el bosque. Reserva previa imprescindible.', mapUrl: maps('San Lucas Treetop Dining Monteverde Costa Rica') },
    ],
  ...
  'santa-teresa': {
    ...
    stayRecommendations: [
      { name: 'Believe Surf & Yoga Lodge', label: 'Nuestra elección', category: 'Hostel', priceRange: '25 USD cama · 150 USD loft', priceBasis: 'según tipo / noche', featured: true, text: 'Nuestra base durante cinco noches, con desayuno, actividades y alquiler de tablas en el propio alojamiento. El precio cambia mucho entre cama compartida y loft privado.', mapUrl: maps('Believe Surf & Yoga Lodge Santa Teresa Costa Rica') },
      { name: 'Otro Lado Lodge', label: 'Calidad-precio', category: 'Lodge', priceRange: '100–200 USD', priceBasis: 'habitación doble / noche', text: 'Una alternativa que distintos blogs destacan por incluir desayuno, piscina y acceso cómodo a la playa.', mapUrl: maps('Otro Lado Lodge Santa Teresa Costa Rica') },
      { name: 'Buena Onda Bungalows', label: 'Calidad-precio', category: 'Bungaló', priceRange: '80–160 USD', priceBasis: 'habitación doble / noche', text: 'Bungalós pequeños y bien situados que aparecen con frecuencia en guías de Santa Teresa para presupuestos medios.', mapUrl: maps('Buena Onda Bungalows Santa Teresa Costa Rica') },
      { name: 'Florblanca', label: 'Opción especial', category: 'Lodge', priceRange: '500–1.000 USD', priceBasis: 'habitación doble / noche', premium: true, text: 'La opción cara más emblemática de Santa Teresa: villas entre selva y playa, servicio boutique y una atmósfera muy cuidada para una estancia especial.', mapUrl: maps('Florblanca Resort Santa Teresa Costa Rica') },
    ],
    ...
    eatRecommendations: [
      { name: 'Soda La Tiquicia', label: 'Soda local', category: 'Soda', priceRange: '8–15 USD', priceBasis: 'por persona', featured: true, text: 'Nuestra recomendación principal para comer cocina costarricense y escapar de los precios internacionales de Santa Teresa: raciones generosas y coste contenido para la zona.', mapUrl: maps('Soda La Tiquicia Santa Teresa Costa Rica') },
      { name: 'Soda Soy Tico', label: 'Soda local', category: 'Soda', priceRange: '8–15 USD', priceBasis: 'por persona', text: 'Casados y platos locales en un formato sencillo; buena candidata para equilibrar el presupuesto entre desayunos y cenas especiales.', mapUrl: maps('Soda Soy Tico Santa Teresa Costa Rica') },
      { name: 'The Bakery', label: 'Calidad-precio', category: 'Café y desayuno', priceRange: '12–25 USD', priceBasis: 'por persona', text: 'Más conocida y menos barata que una soda, pero útil para desayunar o comprar algo rápido antes de la playa.', mapUrl: maps('The Bakery Santa Teresa Costa Rica') },
      { name: "Koji's", label: 'Opción especial', category: 'Cena especial', priceRange: '35–70 USD', priceBasis: 'por persona', premium: true, text: 'La opción cara más recomendada para una cena especial: cocina japonesa, sushi y producto del mar con precios altos incluso para Santa Teresa. Reserva con antelación.', mapUrl: maps("Koji's Santa Teresa Costa Rica") },
    ],
  ...
  'manuel-antonio': {
    ...
    stayRecommendations: [
      { name: 'Glamping Tomaselli', label: 'Nuestra elección', category: 'Bungaló', priceRange: '80–150 USD', priceBasis: 'habitación doble / noche', featured: true, text: 'El alojamiento que usamos en esta etapa; una base tranquila fuera de la primera línea turística.', mapUrl: maps('Glamping Tomaselli Manuel Antonio Costa Rica') },
      { name: 'Tico Tico Villas', label: 'Calidad-precio', category: 'Bungaló', priceRange: '100–180 USD', priceBasis: 'habitación doble / noche', text: 'Apartamentos en la zona de Quepos para ganar espacio y cocina sin subir al precio de los resorts con vistas.', mapUrl: maps('Tico Tico Villas Quepos Costa Rica') },
      { name: 'Hotel Flor Tica', label: 'Calidad-precio', category: 'Hotel', priceRange: '50–90 USD', priceBasis: 'habitación doble / noche', text: 'Opción sencilla en Quepos para quien prioriza presupuesto y conexión en bus con el parque.', mapUrl: maps('Hotel Flor Tica Quepos Costa Rica') },
      { name: 'Shana by the Beach', label: 'Calidad-precio', category: 'Hotel', priceRange: '125–360 USD', priceBasis: 'habitación doble / noche', text: 'Alojamiento próximo a Playa Biesanz; el precio cambia muchísimo por temporada, así que compáralo con opciones de Quepos antes de reservar.', mapUrl: maps('Shana by the Beach Manuel Antonio Costa Rica') },
      { name: 'Arenas del Mar', label: 'Opción especial', category: 'Lodge', priceRange: '500–1.000 USD', priceBasis: 'habitación doble / noche', premium: true, text: 'La opción cara más completa de Manuel Antonio: acceso directo a playa, selva alrededor y un nivel de servicio pensado para convertir el alojamiento en parte del viaje.', mapUrl: maps('Arenas del Mar Beachfront and Rainforest Resort Manuel Antonio Costa Rica') },
    ],
    ...
    eatRecommendations: [
      { name: 'Restaurante Manuel Antonio', label: 'Lo probamos', category: 'Restaurante', priceRange: '15–30 USD', priceBasis: 'por persona', featured: true, text: 'Nuestra opción práctica junto al parque: nos permitió combinar comida y aparcamiento. Comprueba si mantienen esa condición por consumo.', mapUrl: maps('Restaurante Manuel Antonio Costa Rica') },
      { name: 'Miguelitos Pizza', label: 'Lo probamos', category: 'Restaurante', priceRange: '10–20 USD', priceBasis: 'por persona', text: 'Nuestra cena en una zona más local, con precios menos inflados que junto al parque aunque todavía turísticos.', mapUrl: maps('Miguelitos Pizza Quepos Costa Rica') },
      { name: 'Soda Sánchez', label: 'Soda local', category: 'Soda', priceRange: '7–15 USD', priceBasis: 'por persona', text: 'La recomendación económica más repetida en Quepos para desayunos, casados y comida típica a precio cotidiano.', mapUrl: maps('Soda Sanchez Quepos Costa Rica') },
      { name: 'El Patio de Café Milagro', label: 'Calidad-precio', category: 'Café y desayuno', priceRange: '15–30 USD', priceBasis: 'por persona', text: 'Café y restaurante muy conocido de la carretera de Manuel Antonio, con desayunos, café propio y cenas de producto local.', mapUrl: maps('El Patio de Cafe Milagro Manuel Antonio Costa Rica') },
      { name: 'El Lagarto', label: 'Opción especial', category: 'Cena especial', priceRange: '35–65 USD', priceBasis: 'por persona', premium: true, text: 'La cena cara que elegiríamos por las vistas y la parrilla al fuego. Aquí se paga tanto la experiencia como el plato; mejor ir al atardecer y reservar.', mapUrl: maps('El Lagarto Restaurant Manuel Antonio Costa Rica') },
    ],
  ...
  'puerto-viejo': {
    ...
    stayRecommendations: [
      { name: 'Chilamate Holiday House', label: 'Nuestra elección', category: 'Bungaló', priceRange: '120–250 USD', priceBasis: 'habitación doble / noche', featured: true, text: 'Nuestra casa entre vegetación: bonita y muy conectada con la selva, aunque con luz y sonidos de animales durante la noche.', mapUrl: maps('Chilamate Holiday House Puerto Viejo Costa Rica') },
      { name: 'Pagalù Hostel', label: 'Calidad-precio', category: 'Hostel', priceRange: '20 USD cama · 75 USD privada', priceBasis: 'según tipo / noche', text: 'Hostel céntrico citado en guías de presupuesto; el rango cambia entre cama compartida y habitación privada.', mapUrl: maps('Pagalu Hostel Puerto Viejo Costa Rica') },
      { name: 'Roots Family', label: 'Calidad-precio', category: 'Hostel', priceRange: '20 USD cama · 65 USD privada', priceBasis: 'según tipo / noche', text: 'Otra base económica en el pueblo para viajeros que priorizan ubicación y ambiente sobre servicios de resort.', mapUrl: maps('Roots Family Puerto Viejo Costa Rica') },
      { name: 'Namu Garden Hotel & Spa', label: 'Calidad-precio', category: 'Hotel', priceRange: '205–350 USD', priceBasis: 'habitación doble / noche', text: 'Hotel solo para adultos cerca del centro y Playa Negra; es una alternativa cuidada, pero ya entra en presupuesto alto.', mapUrl: maps('Namu Garden Hotel & Spa Puerto Viejo Costa Rica') },
      { name: 'Hotel Aguas Claras', label: 'Opción especial', category: 'Lodge', priceRange: '330–650 USD', priceBasis: 'habitación doble / noche', premium: true, text: 'La opción cara más recomendada del Caribe Sur: diseño, jardines, acceso al mar y una experiencia boutique muy ligada al entorno de Playa Chiquita.', mapUrl: maps('Hotel Aguas Claras Puerto Viejo Costa Rica') },
    ],
    ...
    eatRecommendations: [
      { name: "Soda Lidia's Place", label: 'Soda local', category: 'Soda', priceRange: '8–16 USD', priceBasis: 'por persona', featured: true, text: 'Nuestra recomendación principal para probar rice and beans caribeño y cocina local: un clásico desde 1996 con raciones generosas.', mapUrl: maps("Soda Lidia's Place Puerto Viejo Costa Rica") },
      { name: 'Bread & Chocolate', label: 'Calidad-precio', category: 'Café y desayuno', priceRange: '10–20 USD', priceBasis: 'por persona', text: 'Una opción muy conocida para desayunos y brunch; suele llenarse, así que conviene llegar pronto y revisar el horario.', mapUrl: maps('Bread and Chocolate Puerto Viejo Costa Rica') },
      { name: 'Joe’s Snack Point', label: 'Calidad-precio', category: 'Restaurante', priceRange: '8–16 USD', priceBasis: 'por persona', text: 'Pequeño local caribeño señalado en guías de bajo presupuesto por sus platos informales y ambiente sencillo.', mapUrl: maps("Joe's Snack Point Puerto Viejo Costa Rica") },
      { name: 'La Ventana de Ely', label: 'Soda local', category: 'Soda', priceRange: '6–12 USD', priceBasis: 'por persona', text: 'Pequeño punto de comida local guardado como alternativa a los restaurantes más turísticos del centro.', mapUrl: maps('La Ventana de Ely Puerto Viejo Costa Rica') },
      { name: 'KOKi Beach', label: 'Opción especial', category: 'Cena especial', priceRange: '30–60 USD', priceBasis: 'por persona', premium: true, text: 'La opción cara más redonda para una noche especial en el centro: ambiente caribeño cuidado, cócteles y una carta más elaborada frente al mar.', mapUrl: maps('KOKi Beach Puerto Viejo Costa Rica') },
    ],
