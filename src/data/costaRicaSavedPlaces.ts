...
export const costaRicaSavedPlaces: CostaRicaSavedPlace[] = [
  ...
  { name: 'El Rodeo Estancia Boutique Hotel', zone: 'Alajuela', category: 'Dormir', status: 'Nuestra elección', note: 'Nuestra primera noche cerca del aeropuerto, con aparcamiento y salida práctica hacia la ruta.', mapUrl: maps('El Rodeo Estancia Boutique Hotel Alajuela Costa Rica'), image: '/hotels/hotel-el-rodeo.jpg' },
  { name: 'Natura Bungalows', zone: 'La Fortuna', category: 'Dormir', status: 'Nuestra elección', note: 'Nuestro alojamiento favorito del viaje: bungaló independiente, tranquilidad y vistas al Arenal cuando despejaba.', mapUrl: maps('Natura Bungalows La Fortuna Costa Rica'), image: '/hotels/hotel-natura-bungalows.jpg' },
  { name: 'Monteverde Eco Love', zone: 'Monteverde', category: 'Dormir', status: 'Nuestra elección', note: 'La base de nuestra etapa en Monteverde, bien situada para movernos por Santa Elena.', mapUrl: maps('Monteverde Eco Love Costa Rica'), image: '/hotels/hotel-monteverde-ecolove.jpg' },
  { name: 'Believe Surf & Yoga Lodge', zone: 'Santa Teresa', category: 'Dormir', status: 'Nuestra elección', note: 'Nuestra base durante cinco noches, con desayuno, ambiente viajero y alquiler de tablas.', mapUrl: maps('Believe Surf & Yoga Lodge Santa Teresa Costa Rica'), image: '/hotels/hotel-believe-surf-yoga.jpg' },
  { name: 'Glamping Tomaselli', zone: 'Manuel Antonio', category: 'Dormir', status: 'Nuestra elección', note: 'El alojamiento de nuestra etapa entre Quepos y Manuel Antonio.', mapUrl: maps('Glamping Tomaselli Manuel Antonio Costa Rica'), image: '/hotels/hotel-glamping-tomaselli.jpg' },
  { name: 'Chilamate Holiday House', zone: 'Puerto Viejo', category: 'Dormir', status: 'Nuestra elección', note: 'Nuestra casa en Playa Negra para cerrar la ruta por el Caribe.', mapUrl: maps('Chilamate Holiday House Puerto Viejo Costa Rica'), image: '/hotels/hotel-chilamate.jpg' },
