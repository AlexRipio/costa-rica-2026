...
export const travelJournals: Record<string, TravelJournal> = {
  ...
  'asturias-luarca': {
    ...
    kicker: 'España · guía de Asturias',
    introTitle: 'Asturias, entre el Cantábrico y la montaña.',
    intro: ['Asturias forma parte de nuestros viajes nacionales. Antes de añadir playas, pueblos o una ruta de carretera necesitamos revisar el material real del viaje para que la guía sea útil y fiel a lo que vivimos.'],
    companions: 'TODO: confirmar acompañantes',
    tripType: 'Viaje nacional',
    mapQuery: 'Asturias Spain',
    statement: { before: 'Asturias pide una ruta con', accent: 'tiempo y paisaje', after: 'sin convertir cada parada en una carrera.' },
    confirmed: ['Viaje realizado a Asturias.'],
    route: [{ label: 'Ruta pendiente de reconstruir', title: 'Asturias', text: 'Añadiremos el recorrido cuando revisemos fotografías y reservas para no publicar una ruta inventada.' }],
    places: [{ title: 'Asturias', text: 'La guía crecerá con los lugares concretos que podamos confirmar y recomendar de verdad.' }],
    reflections: [],
    practical: [],
    gallery: [],
    ...
    todoPhotos: ['TODO: foto de portada de Asturias', 'TODO: fotografías personales de Asturias'],
  },
  calpe: {
    slug: 'calpe',
